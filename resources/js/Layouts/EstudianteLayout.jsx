...
import {
    LayoutDashboard, Calendar, Award, CalendarCheck, UserCircle,
...
export default function EstudianteLayout({ children, title = 'Dashboard' }) {
    ...
    const menu = {
        ...
        aprendizaje: [
            { icon: Calendar,      label: 'Cronograma',    href: '/estudiante/cronograma' },
            { icon: Award,         label: 'Mis Notas',     href: '/estudiante/mis-notas' },
            { icon: CalendarCheck, label: 'Mi Asistencia', href: '/estudiante/mi-asistencia' },
        ],
        cuenta: [
            ...
            <aside className={`fixed left-0 top-0 z-50 w-64 h-screen flex flex-col bg-primary-900
                ...
                <div className="flex items-center gap-3 px-4 py-5 border-b border-primary-800 shrink-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-primary-300 text-[10px]">Portal Estudiantil</p>
                    </div>
                ...
                <nav className="flex-1 overflow-y-auto px-2 py-2">
                    ...
                    <SidebarSection label="Mi Aprendizaje" />
                    {menu.aprendizaje.map(item => <SidebarItem key={item.label} {...item} currentPath={currentPath} />)}
